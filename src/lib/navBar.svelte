...
<div id="mobileNav" class="overlay">
	...
	<a class="closebtn" on:click={closeNav} role="button" aria-label="Close navigation" href="#"
		>&times;</a
	>
	<!-- Overlay content -->
	<div class="overlay-content">
		...
		<a href="#" role="button" on:click|preventDefault={() => updateContent('/experiences')}
			>Experiences</a
		>
		<a href="#" role="button" on:click|preventDefault={() => updateContent('/projects')}>Chatbot</a>
...
<button on:click={openNav} class="hidden-broswer mobileBar"> Menu </button>
